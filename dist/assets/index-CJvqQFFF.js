const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-P0zOS-QV.js","assets/react-CDaM45aE.js","assets/ProdGrid-B8Tx3Eh_.js","assets/OptimizedImage-BG24cf-E.js","assets/ModalCommander-ChxJKNir.js","assets/checkoutApi-CwrvVeFr.js","assets/supabase-D2gm834s.js","assets/ProductRouteSections-D2s2UXxQ.js","assets/LivraisonPage-BQPawwkZ.js","assets/SiteMarketingPages-1GNYx1bf.js","assets/LivraisonLazyBlocks-BfDdiDsU.js","assets/FicheProduit-DReiERdZ.js","assets/PrestPage-ClWf43fL.js","assets/CheckoutPage-ClKGs7Gl.js","assets/FreeShippingProgress-BCARfxN8.js","assets/CartPage-Br2GY4O-.js","assets/AcademyDetail-GsvAAebk.js","assets/AcademyContactForm-dQd_u_TW.js","assets/LoyaltyPage-uH3KBiOy.js","assets/SellerDashboard-DVu4-WS9.js","assets/BuyerDashboard-XkS200aH.js","assets/DeliveryDashboard-DsiNQjYf.js","assets/ProviderDashboard-Wsehex0h.js","assets/AdminDashboard-KaeOQznf.js","assets/NotificationsPage-C-lnw-Qz.js","assets/PromotionsPage-eG4cV4a6.js"])))=>i.map(i=>d[i]);
var Uo=Object.defineProperty;var Wo=(r,o,t)=>o in r?Uo(r,o,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[o]=t;var te=(r,o,t)=>Wo(r,typeof o!="symbol"?o+"":o,t);import{r as l,a as Vo,R as Ho,g as Tr,b as oe}from"./react-CDaM45aE.js";import{c as Xo}from"./supabase-D2gm834s.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const n of c.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(a){if(a.ep)return;a.ep=!0;const c=t(a);fetch(a.href,c)}})();var _t={exports:{}},Ze={};/**
 * @license React
 ...
 */var Go=l,Jo=Symbol.for("react.element"),Ko=Symbol.for("react.fragment"),Qo=Object.prototype.hasOwnProperty,Zo=Go.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,ei={key:!0,ref:!0,__self:!0,__source:!0};function Et(r,o,t){var i,a={},c=null,n=null;t!==void 0&&(c=""+t),o.key!==void 0&&(c=""+o.key),o.ref!==void 0&&(n=o.ref);for(i in o)Qo.call(o,i)&&!ei.hasOwnProperty(i)&&(a[i]=o[i]);if(r&&r.defaultProps)for(i in o=r.defaultProps,o)a[i]===void 0&&(a[i]=o[i]);return{$$typeof:Jo,type:r,key:c,ref:n,props:a,_owner:Zo.current}}Ze.Fragment=Ko;Ze.jsx=Et;Ze.jsxs=Et;_t.exports=Ze;var e=_t.exports,jr={},nt=Vo;jr.createRoot=nt.createRoot,jr.hydrateRoot=nt.hydrateRoot;/**
...
`),G=`mailto:raisaodin1@gmail.com?subject=${encodeURIComponent(D)}&body=${encodeURIComponent(Y)}`;setTimeout(()=>window.open(G,"_blank"),500),Wr(!0)}catch(s){console.error("soumettreCandidaturePrestataire:",s),we("Erreur : "+(s.message||"Impossible d'envoyer la candidature. Réessayez."))}Vr(!1)},[zo,zn]=l.useState([{text:"Bonjour ! Comment puis-je vous aider ?",me:!1,time:"10:02"}]),[Cn,_n]=l.useState(""),[En,Tn]=l.useState(!1),Co=l.useRef(null);l.useEffect(()=>{if(!localStorage.getItem("yorix_onboarding_seen")){const f=setTimeout(()=>Ae(!0),800);return()=>clearTimeout(f)}},[]);const _o=l.useCallback(s=>{localStorage.setItem("yorix_onboarding_seen","1"),Ae(!1);const u={buy:{needAuth:!1,page:"produits"},sell:{needAuth:!0,role:"seller",page:"dashboard"},service:{needAuth:!1,page:"prestataires"},delivery:{needAuth:!0,role:"buyer",action:"openDelivery"}}[s];if(u){if(u.needAuth&&!n){$r(s),M(u.role||"buyer"),h("register"),v(!0);return}cr(s)}},[n]),cr=l.useCallback(s=>{const f=s||ve;f&&(f==="buy"?z("produits"):f==="sell"?z("dashboard"):f==="service"?z("prestataires"):f==="delivery"&&(z("livraison"),setTimeout(()=>sr(!0),300)),$r(null))},[ve]),Eo=l.useCallback(()=>{localStorage.setItem("yorix_onboarding_seen","1"),Ae(!1)},[]),z=l.useCallback((s,f={})=>{r(ur(s,f)),window.scrollTo(0,0),_e(!1)},[r]);l.useEffect(()=>{let s=!1;N.auth.getSession().then(({data:{session:u},error:j})=>{s||(j&&console.warn("Auth getSession:",j.message),u!=null&&u.user&&(p(u.user),Ye(u.user.id)),y(!1))}).catch(u=>{console.warn("Auth getSession:",(u==null?void 0:u.message)||u),s||y(!1)});const{data:{subscription:f}}=N.auth.onAuthStateChange((u,j)=>{j!=null&&j.user?(p(j.user),Ye(j.user.id)):(p(null),m(null),b(null),be([]))});return()=>{s=!0,f.unsubscribe()}},[]);const Ye=async s=>{const f=await ya(s),u=va(f);m(f),b(u),await qr(s,40)};l.useEffect(()=>{if(!(n!=null&&n.id))return;const s=N.channel(`notifications_rt_${n.id}`).on("postgres_changes",{event:"INSERT",schema:"public",table:"notifications",filter:`user_id=eq.${n.id}`},f=>{const u=f.new;be(j=>j.some(D=>D.id===u.id)?j:[u,...j].slice(0,120));try{pn(Lr(u),Dr.current)}catch{}}).subscribe();return()=>{N.removeChannel(s)}},[n==null?void 0:n.id]),l.useEffect(()=>{if(!("serviceWorker"in navigator))return;const s=f=>{var j;if(((j=f.data)==null?void 0:j.type)!=="NOTIF_NAV")return;const u=typeof f.data.url=="string"?f.data.url:"/";r(u.startsWith("/")?u:`/${u}`)};return navigator.serviceWorker.addEventListener("message",s),()=>navigator.serviceWorker.removeEventListener("message",s)},[r]),l.useEffect(()=>{P(!0);const s=async()=>{let u=N.from("products").select("*").or("actif.eq.true,actif.is.null").order("sponsorise",{ascending:!1}).order("created_at",{ascending:!1}).limit(60);ie&&(u=u.eq("categorie",ie));const{data:j,error:D}=await u;D&&console.warn("Produits:",D.message),me(j||[]),P(!1)};s();const f=N.channel("prod_rt").on("postgres_changes",{event:"*",schema:"public",table:"products"},s).subscribe();return()=>N.removeChannel(f)},[ie]),l.useEffect(()=>{var s;(s=Co.current)==null||s.scrollIntoView({behavior:"smooth"})},[zo]);const $e=o.pathname;l.useEffect(()=>{if(t.categorySlug){const s=Ti(t.categorySlug,kt);ae(s||"")}else t.page==="produits"&&$e==="/produits"&&ae("")},[t.categorySlug,t.page,$e]);const de=l.useMemo(()=>{var s;return t.citySlug?(s=$[t.citySlug])==null?void 0:s.name:null},[t.citySlug]),To=l.useMemo(()=>{var s;return t.page==="prestataires"&&t.metierSlug&&t.villeSlug?{cat:Ot[t.metierSlug]||"",ville:((s=$[t.villeSlug])==null?void 0:s.name)||""}:t.page==="seoCity"&&t.cityMode==="prestataires"&&de?{cat:"",ville:de}:t.page==="prestataires"&&$e==="/prestataires"?{cat:"",ville:""}:null},[t.page,t.metierSlug,t.villeSlug,t.cityMode,de,$e]);l.useEffect(()=>{if(t.page!=="academyDetail"&&t.page!=="academyContact")return;const s=t.courseId;if(!s||!qe.length)return;const f=qe.find(u=>String(u.id)===String(s));f&&dr(f)},[t.page,t.courseId,qe]),l.useEffect(()=>{if(t.page!=="productDetail"||!t.productSlug){Be(null),Re(!1);return}const{id:s}=xt(t.productSlug);if(!s){Be(null),Re(!1);return}let f=!1;return Re(!0),N.from("products").select("*").eq("id",s).maybeSingle().then(({data:u,error:j})=>{f||(j&&console.warn("Détail produit:",j.message),Be(u||null),Re(!1))}).catch(u=>{f||(console.warn("Détail produit:",(u==null?void 0:u.message)||u),Be(null),Re(!1))}),()=>{f=!0}},[t.page,t.productSlug]),l.useEffect(()=>{if(t.page!=="prestDetail"||!t.prestSlug){t.page!=="prestDetail"&&ye(null);return}const{id:s}=xt(t.prestSlug);if(!s){ye(null);return}const f=ha.find(j=>j.id===s);if(f){ye(f);return}const u=F.find(j=>`real-${j.id}`===s||String(j.id)===s);ye(u?{id:`real-${u.id}`,name:u.provider_nom||"Prestataire Yorix",metier:u.nom||"Service",categorie:u.categorie||"Autre",ville:u.ville||"Cameroun",quartier:"",emoji:"🛠️",photo:null,color_bg:"linear-gradient(135deg, #dcfce7, #bbf7d0)",tags:[u.categorie||"Service"].filter(Boolean),note:u.note||5,avis:u.nombre_avis||0,prix:u.prix?`${Number(u.prix).toLocaleString("fr-FR")} FCFA`:"",verifie:!0,dispo:u.disponible!==!1,bio:u.description||"",telephone:"",realisations:0,isReal:!0}:null)},[t.page,t.prestSlug,F]);const Ao=async()=>{I(""),H(!0);try{const{data:s,error:f}=await N.auth.signInWithPassword({email:T.email,password:T.password});if(f)throw f;p(s.user),await Ye(s.user.id),v(!1),ve&&setTimeout(()=>cr(ve),300),Sa({to:T.email,subject:`Bienvenue sur Yorix, ${T.nom} ! 🎉`,html:Ca(T.nom,w)}).catch(u=>console.warn("Email bienvenue:",u))}catch{I("Email ou mot de passe incorrect.")}H(!1)},Hr=async()=>{var s;I(""),H(!0);try{if(!T.nom||!T.email||!T.password||!T.tel)throw new Error("Tous les champs sont obligatoires.");if(!w)throw new Error("Veuillez choisir un profil (Acheteur, Vendeur, Livreur ou Prestataire).");if(["seller","provider","delivery"].includes(w)&&!fo){Yr({nom:T.nom,email:T.email,tel:T.tel,password:T.password,role:w}),H(!1),lr(!0);return}const{data:u,error:j}=await N.auth.signUp({email:T.email,password:T.password,options:{data:{display_name:T.nom,nom:T.nom,telephone:T.tel,role:w}}});if(j)throw j;const D=(s=u.user)==null?void 0:s.id;if(!D)throw new Error("Erreur création compte.");const{error:Y}=await N.from("profiles").upsert({id:D,nom:T.nom,email:T.email,telephone:T.tel,role:w,langue:"fr",actif:!0,verifie:!1,note:0,nombre_avis:0,total_commandes:0});Y&&console.error("Profile insert error:",Y),await N.from("wallets").insert({user_id:D,solde:0,total_gagne:0,devise:"FCFA"}).then(G=>G.error&&console.error(G.error)),await Ye(D),v(!1),q({nom:"",email:"",tel:"",password:""}),Br(!1),Yr(null),ve&&setTimeout(()=>cr(ve),500)}catch(f){console.error("Register error:",f),I(f.message.includes("already")?"Cet email est déjà utilisé.":f.message)}H(!1)},No=async()=>{const{error:s}=await N.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}});s&&I(s.message)},Xr=async()=>{await N.auth.signOut(),p(null),m(null),b(null),le("overview"),z("home")},Ro=async s=>{lr(!1),Br(!0),setTimeout(()=>{Hr()},200)},Fe=l.useCallback(s=>{const f=en(s);f&&Ce(u=>zt(u,f))},[]),Mo=l.useCallback(s=>{const f=rn(s);f&&Ce(u=>zt(u,f))},[]),Po=(s,f,u=null)=>Ce(j=>tn(j,s,u,f)),Io=(s,f=null)=>Ce(u=>on(u,s,f)),pr=l.useMemo(()=>an(ue,he),[ue,he]),gr=pr.qty,Lo=l.useCallback(async s=>{if(!(n!=null&&n.id)||!s)return;const f={};if(s.telephone!=null&&String(s.telephone).trim()!==""&&(f.telephone=String(s.telephone).trim()),s.adresse!=null&&(f.adresse=String(s.adresse).trim()),s.ville!=null&&(f.ville=String(s.ville).trim()),s.nom!=null&&(f.nom=String(s.nom).trim()),!Object.keys(f).length)return;const{error:u}=await N.from("profiles").update(f).eq("id",n.id);if(u){console.warn("Profil checkout non sauvegardé:",u.message||u);return}m(j=>j&&{...j,...f})},[n==null?void 0:n.id]),fr=l.useCallback(s=>io(f=>{const u=new Set(f);return u.has(s)?u.delete(s):u.add(s),u}),[]),Gr=async(s,f={navigate:!0,closeDrawer:!0})=>{const u=typeof s=="object"?s.id:s,j=typeof s=="object"?s:Ee.find(Y=>Y.id===u);try{const{error:Y}=await N.from("notifications").update({lu:!0}).eq("id",u);Y&&console.warn("marquerNotifLue:",Y.message)}catch(Y){console.warn("marquerNotifLue exception:",Y==null?void 0:Y.message)}if(be(Y=>Y.map(G=>G.id===u?{...G,lu:!0}:G)),f.closeDrawer&&_e(!1),!f.navigate||!j)return;const D=String(j.link||"").trim();if(D.startsWith("http")){window.open(D,"_blank","noopener,noreferrer");return}if(D.startsWith("/")){r(D);return}j.type==="new_product"||D.includes("/products/")?z("produits"):j.type==="new_message"&&(z("dashboard"),le("messages"))},Jr=async s=>{if(s){try{const{error:f}=await N.from("notifications").delete().eq("id",s);f&&console.warn("supprimerNotif:",f.message)}catch(f){console.warn("supprimerNotif:",f==null?void 0:f.message)}be(f=>f.filter(u=>u.id!==s))}},Kr=async()=>{const s=Ee.filter(f=>!f.lu).map(f=>f.id);if(s.length!==0){try{const{error:f}=await N.from("notifications").update({lu:!0}).in("id",s);f&&console.warn("marquerToutesLues:",f.message)}catch(f){console.warn("marquerToutesLues exception:",f==null?void 0:f.message)}be(f=>f.map(u=>({...u,lu:!0})))}},Ue=Ee.filter(s=>!s.lu).length,Oo=l.useMemo(()=>{let s=W.filter(f=>{var u,j;return!L||((u=f.name_fr)==null?void 0:u.toLowerCase().includes(L.toLowerCase()))||((j=f.description_fr)==null?void 0:j.toLowerCase().includes(L.toLowerCase()))});if(i==="seoCity"&&t.cityMode==="acheter"&&de){const f=de.toLowerCase();s=s.filter(u=>{const j=(u.ville||"").toLowerCase();return!j||j.includes(f)||f.includes(j)})}return s},[W,L,i,t.cityMode,de]),Qr=i==="seoCity"||i==="livraison"&&!!t.citySlug,Zr=i==="produits"||i==="seoCity"&&t.cityMode==="acheter",Do=i==="livraison"||i==="seoCity"&&t.cityMode==="livraison",qo=i==="prestataires"||i==="prestDetail"||i==="seoCity"&&t.cityMode==="prestataires",Bo=Zr||i==="escrow",Yo=l.useMemo(()=>["faq","devenirVendeur","devenirLivreur","inscription","business","academy","blog","contact","aide","cgv","mentions","confidentialite"].includes(i),[i]),et=l.useCallback(s=>s==="produits"?i==="produits"||i==="seoCity"&&t.cityMode==="acheter":s==="livraison"?i==="livraison"||i==="seoCity"&&t.cityMode==="livraison":s==="prestataires"?i==="prestataires"||i==="prestDetail"||i==="seoCity"&&t.cityMode==="prestataires":i===s,[i,t.cityMode]),rt=l.useCallback(s=>{z("productDetail",{productSlug:mt(s.name_fr||s.name,s.id)})},[z]),tt=()=>({buyer:"chip-buyer",seller:"chip-seller",delivery:"chip-delivery",provider:"chip-provider",admin:"chip-admin"})[x]||"chip-buyer",$o=()=>x==="seller"?[{icon:"📊",id:"overview",label:"Vue d'ensemble"},{icon:"🏪",id:"mesProduits",label:"Mes produits"},{icon:"➕",id:"ajouterProduit",label:"Ajouter produit"},{icon:"📦",id:"commandes",label:"Commandes"},{icon:"💰",id:"wallet",label:"Wallet"}]:x==="delivery"?[{icon:"📊",id:"overview",label:"Vue d'ensemble"},{icon:"🟡",id:"disponibles",label:"Disponibles"},{icon:"🚚",id:"enCours",label:"En cours"},{icon:"✅",id:"historique",label:"Historique"},{icon:"💰",id:"wallet",label:"Gains"}]:x==="provider"?[{icon:"📊",id:"overview",label:"Vue d'ensemble"},{icon:"📋",id:"demandes",label:"Demandes"},{icon:"🛠️",id:"mesServices",label:"Mes services"},{icon:"+",id:"ajouterService",label:"Ajouter service"}]:[{icon:"📊",id:"overview",label:"Vue d'ensemble"},{icon:"📦",id:"commandes",label:"Mes commandes"},{icon:"❤️",id:"favoris",label:"Favoris"},{icon:"🌟",id:"loyalty",label:"Fidélité"}],Fo=[{l:"🏠 Accueil",p:"home"},{l:"🛍️ Produits",p:"produits"},{l:"🎁 Bons plans",p:"bonsPlans"},{l:"🚚 Livraison",p:"livraison"},{l:"🔐 Escrow",p:"escrow"},{l:"👷 Prestataires",p:"prestataires"},{l:"💼 Business",p:"business"},{l:"🎓 Academy",p:"academy"},{l:"📰 Blog",p:"blog"},{l:"🌟 Fidélité",p:"loyalty"},{l:"📞 Contact",p:"contact"},{l:"🆘 Aide",p:"aide"},...n&&((d==null?void 0:d.role)==="admin"||(d==null?void 0:d.role)==="superadmin")?[{l:"⚙️ Admin",p:"admin"}]:[]],ce=l.useMemo(()=>{const s=t.canonicalPath||o.pathname,f={"@context":"https://schema.org","@type":"Organization",name:"Yorix CM",alternateName:"Yorix Cameroun",url:J,logo:`${J}/favicon.svg`,image:`${J}/og-image.svg`,email:"support@yorix.cm",telephone:"+237696565654",foundingDate:"2025",address:{"@type":"PostalAddress",addressCountry:"CM",addressLocality:"Douala",addressRegion:"Littoral"},areaServed:{"@type":"Country",name:"Cameroun"},contactPoint:[{"@type":"ContactPoint",telephone:"+237696565654",contactType:"customer service",areaServed:"CM",availableLanguage:["French","English"]}],sameAs:["https://www.facebook.com/yorixcm","https://www.instagram.com/yorixcm","https://wa.me/237696565654"]},u=R=>R!=null&&R.length?{"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:R.map((U,pe)=>{var ke;return{"@type":"ListItem",position:pe+1,name:U.name,item:(ke=U.path)!=null&&ke.startsWith("http")?U.path:`${J}${U.path||"/"}`}})}:null,j={"@context":"https://schema.org","@type":"WebSite",name:"Yorix CM",url:J,potentialAction:{"@type":"SearchAction",target:`${Ni()}?q={search_term_string}`,"query-input":"required name=search_term_string"}};if(i==="dashboard"||i==="admin")return{title:"Espace membre — Yorix CM",description:"Tableau de bord Yorix.",canonicalPath:s,noindex:!0,jsonLd:[]};if(i==="home")return{title:"Yorix.cm — Marketplace Cameroun | Achat en ligne, livraison, escrow, prestataires",description:"Yorix est une marketplace camerounaise : achat en ligne, vendre en ligne, livreur & livraison Douala, Yaoundé, Bafoussam, escrow MTN MoMo & Orange Money, prestataires vérifiés.",canonicalPath:"/",keywords:"marketplace Cameroun, achat en ligne Cameroun, vendre en ligne Cameroun, livraison Cameroun, livreur Cameroun, escrow Cameroun, prestataires Cameroun, Douala, Yaoundé, Bafoussam",jsonLd:[f,j]};if(i==="productDetail"&&Ne){const R=Ne,U=R.image&&String(R.image).startsWith("http")?R.image:Array.isArray(R.image_urls)&&R.image_urls[0]?R.image_urls[0]:`${J}/og-image.svg`,pe=R.description_fr&&String(R.description_fr).slice(0,158)||`Acheter ${R.name_fr||"ce produit"} sur Yorix — marketplace & livraison Cameroun.`,ke={"@context":"https://schema.org","@type":"Product",name:R.name_fr||"Produit Yorix",image:U,description:pe,brand:{"@type":"Brand",name:"Yorix CM"},offers:{"@type":"Offer",url:`${J}${s}`,priceCurrency:"XAF",price:R.prix,availability:"https://schema.org/InStock"}},mr=u([{name:"Accueil",path:"/"},{name:"Produits",path:"/produits"},{name:R.name_fr||"Produit",path:s}]);return{title:`${R.name_fr||"Produit"} — achat en ligne Cameroun | Yorix.cm`,description:pe,canonicalPath:s,ogType:"product",ogImage:U.startsWith("http")?U:`${J}/og-image.svg`,jsonLd:[ke,mr,f]}}if(i==="notifications")return{title:"Notifications — alertes commandes & messages | Yorix.cm",description:"Historique de vos alertes Yorix : commandes, paiements, livraisons, prestations et messages.",canonicalPath:"/notifications",noindex:!0,jsonLd:[f]};if(i==="faq")return{title:"FAQ Yorix — marketplace, livraison, escrow Cameroun",description:"Réponses sur l’achat en ligne, la livraison, les prestataires, MTN MoMo, Orange Money et l’escrow sur Yorix.cm.",canonicalPath:"/faq",jsonLd:[{"@context":"https://schema.org","@type":"FAQPage",mainEntity:[{"@type":"Question",name:"Comment acheter sur Yorix au Cameroun ?",acceptedAnswer:{"@type":"Answer",text:"Parcourez les produits, ajoutez au panier et finalisez via WhatsApp ou paiement mobile (MTN MoMo, Orange Money)."}},{"@type":"Question",name:"La livraison couvre quelles villes ?",acceptedAnswer:{"@type":"Answer",text:"Douala, Yaoundé, Bafoussam, Bamenda, Kribi et un réseau national en expansion. Délais J+1 sur les grandes villes."}},{"@type":"Question",name:"Comment fonctionne l’escrow Yorix ?",acceptedAnswer:{"@type":"Answer",text:"Les fonds sont sécurisés jusqu’à confirmation de réception par l’acheteur, puis libérés au vendeur."}}]},f]};if(i==="seoCity"&&t.citySlug&&$[t.citySlug]){const R=$[t.citySlug].name,U={hub:{title:`Yorix ${R} — marketplace, livraison & prestataires | Cameroun`,desc:`Marketplace à ${R} : acheter en ligne, livraison, services et escrow. MTN MoMo, Orange Money — Yorix.cm.`},acheter:{title:`Acheter en ligne à ${R} — marketplace Yorix Cameroun`,desc:`Achat en ligne à ${R} : produits vérifiés, paiement mobile, livraison. La marketplace camerounaise Yorix.`},livraison:{title:`Livraison à ${R} — livreur & colis | Yorix Ride Cameroun`,desc:`Service de livraison rapide à ${R} et partout au Cameroun. Suivi, tarifs clairs — Yorix Ride.`},prestataires:{title:`Prestataires à ${R} — services à domicile | Yorix.cm`,desc:`Trouvez des prestataires vérifiés à ${R} : plomberie, électricité, ménage, beauté, informatique…`}},pe=U[t.cityMode]||U.hub,ke={"@context":"https://schema.org","@type":"LocalBusiness",name:`Yorix — ${R}`,url:`${J}${s}`,address:{"@type":"PostalAddress",addressLocality:R,addressCountry:"CM"},areaServed:{"@type":"City",name:R},parentOrganization:{"@type":"Organization",name:"Yorix CM"}},mr=u([{name:"Accueil",path:"/"},{name:R,path:s}]);return{title:pe.title,description:pe.desc,canonicalPath:s,jsonLd:[ke,mr,f]}}const D={produits:"Produits — marketplace en ligne Cameroun | Yorix.cm",livraison:"Livraison Cameroun — livreurs Yorix Ride | Douala, Yaoundé",escrow:"Escrow Cameroun — paiement sécurisé marketplace | Yorix.cm",prestataires:"Prestataires Cameroun — services à domicile vérifiés | Yorix.cm",business:"Yorix Business — solutions B2B marketplace Cameroun",blog:"Blog Yorix — actualités marketplace Cameroun",academy:"Yorix Academy — formations e-commerce Cameroun",loyalty:"Fidélité Yorix — points & récompenses",contact:"Contact Yorix — support marketplace Cameroun",aide:"Centre d'aide Yorix — marketplace & livraison Cameroun",faq:"FAQ Yorix — achat, livraison, escrow, vendeurs | Cameroun",cgv:"CGV Yorix.cm — conditions générales de vente",confidentialite:"Politique de confidentialité — Yorix.cm",mentions:"Mentions légales — Yorix.cm",devenirVendeur:"Devenir vendeur sur Yorix — marketplace Cameroun",devenirLivreur:"Devenir livreur Yorix Ride — livraison Cameroun",inscription:"Devenir prestataire Yorix — services Cameroun"},Y={produits:"Produits",livraison:"Livraison",escrow:"Escrow & sécurité",prestataires:"Prestataires",business:"Business",blog:"Blog",academy:"Academy",loyalty:"Fidélité",contact:"Contact",aide:"Centre d'aide",faq:"FAQ",cgv:"CGV",confidentialite:"Confidentialité",mentions:"Mentions légales",devenirVendeur:"Devenir vendeur",devenirLivreur:"Devenir livreur",inscription:"Devenir prestataire",bonsPlans:"Bons plans"},G=D[i];if(G){const R=Y[i],U=R?u([{name:"Accueil",path:"/"},{name:R,path:Qe[i]||s}]):null;return{title:G,description:"Yorix.cm — marketplace & super-app pour acheter, vendre, se faire livrer et trouver des prestataires au Cameroun. MTN MoMo, Orange Money, escrow.",canonicalPath:Qe[i]||s,jsonLd:[U,f].filter(Boolean)}}return{title:"Yorix CM — Marketplace #1 au Cameroun",description:"Marketplace camerounaise : produits, livraison, prestataires, escrow MTN MoMo & Orange Money.",canonicalPath:s,jsonLd:[f]}},[i,t.canonicalPath,t.citySlug,t.cityMode,o.pathname,Ne]);return k?e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",fontFamily:"'DM Sans',sans-serif",color:"#1a6b3a",gap:12},children:[e.jsx("div",{style:{width:40,height:40,border:"4px solid #e2ddd6",borderTopColor:"#1a6b3a",borderRadius:"50%",animation:"spin .7s linear infinite"}}),"Chargement de Yorix...",e.jsx("style",{children:"@keyframes spin{to{transform:rotate(360deg);}}"})]}):e.jsxs(e.Fragment,{children:[e.jsx("style",{children:_a(a)}),e.jsx(sa,{title:ce.title,description:ce.description,canonicalPath:ce.canonicalPath,keywords:ce.keywords,ogType:ce.ogType||"website",jsonLd:ce.jsonLd,noindex:ce.noindex}),e.jsx(vn,{open:go,onClose:()=>{lr(!1),H(!1),I("Vous devez accepter le contrat pour finaliser votre inscription.")},onAccepted:Ro,user:n,userData:d,role:w,authForm:T}),e.jsx(yn,{open:mo,onClose:Eo,onSelectAction:_o,user:n}),po&&e.jsx(Ea,{user:n,userData:d,onClose:()=>sr(!1),onSuccess:s=>{console.log("Livraison créée avec code:",s)}}),S&&e.jsx("div",{className:"modal-overlay",onClick:s=>s.target===s.currentTarget&&v(!1),children:e.jsxs("div",{className:"modal",style:{width:"100%",maxWidth:480,margin:"0 auto"},children:[e.jsx("button",{className:"modal-close",onClick:()=>v(!1),children:"✕"}),e.jsx("div",{className:"modal-title",children:g==="login"?"Bon retour ! 👋":"Rejoindre Yorix 🇨🇲"}),e.jsx("p",{className:"modal-sub",children:"Votre marketplace camerounaise de confiance"}),e.jsxs("div",{className:"auth-tabs",children:[e.jsx("button",{className:`auth-tab${g==="login"?" active":""}`,onClick:()=>{h("login"),I("")},children:"🔑 Connexion"}),e.jsx("button",{className:`auth-tab${g==="register"?" active":""}`,onClick:()=>{h("register"),I("")},children:"🚀 Inscription"})]}),E&&e.jsxs("div",{className:"error-msg",children:["⚠️ ",E]}),g==="register"&&e.jsxs(e.Fragment,{children:[e.jsx("div",{style:{background:"var(--green-pale)",border:"1px solid var(--green-light)",borderRadius:9,padding:"10px 12px",marginBottom:12,fontSize:".78rem",color:"var(--green)",fontWeight:600},children:"👇 Choisissez votre profil pour commencer"}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:14},children:[{id:"buyer",icon:"🛍️",label:"Acheteur",desc:"J'achète des produits"},{id:"seller",icon:"🏪",label:"Vendeur",desc:"Je vends mes produits"},{id:"delivery",icon:"🚚",label:"Livreur",desc:"J'effectue des livraisons"},{id:"provider",icon:"👷",label:"Prestataire",desc:"Je propose des services"}].map(s=>e.jsxs("div",{onClick:()=>M(s.id),style:{border:`2px solid ${w===s.id?"var(--green)":"var(--border)"}`,borderRadius:10,padding:"12px 10px",cursor:"pointer",background:w===s.id?"var(--green-pale)":"var(--surface)",textAlign:"center",transition:"all .2s"},children:[e.jsx("div",{style:{fontSize:"1.8rem",marginBottom:4},children:s.icon}),e.jsx("div",{style:{fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:".82rem",color:"var(--ink)"},children:s.label}),e.jsx("div",{style:{fontSize:".67rem",color:"var(--gray)",marginTop:2},children:s.desc}),w===s.id&&e.jsx("div",{style:{marginTop:5,fontSize:".62rem",fontWeight:700,color:"var(--green)"},children:"✅ Sélectionné"})]},s.id))}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Nom complet ",e.jsx("span",{children:"*"})]}),e.jsx("input",{className:"form-input",placeholder:"Ex: Amina Bello",value:T.nom,onChange:s=>q(f=>({...f,nom:s.target.value}))})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Téléphone ",e.jsx("span",{children:"*"})]}),e.jsx("input",{className:"form-input",type:"tel",placeholder:"+237 6XX XXX XXX",value:T.tel,onChange:s=>q(f=>({...f,tel:s.target.value}))})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Email ",e.jsx("span",{children:"*"})]}),e.jsx("input",{className:"form-input",type:"email",placeholder:"votre@email.com",value:T.email,onChange:s=>q(f=>({...f,email:s.target.value}))})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Mot de passe ",e.jsx("span",{children:"*"})]}),e.jsx(kn,{value:T.password,onChange:s=>q(f=>({...f,password:s})),placeholder:g==="login"?"Entrez votre mot de passe":"Choisissez un mot de passe",autoComplete:g==="login"?"current-password":"new-password",showStrength:g==="register",showRules:g==="register",ariaLabel:"Mot de passe",id:"auth-password"}),g==="login"&&e.jsx("div",{style:{fontSize:".7rem",color:"var(--gray)",marginTop:5,display:"flex",alignItems:"center",gap:4},children:"💡 Cliquez sur l'œil pour afficher ou masquer votre mot de passe"})]}),e.jsx("button",{className:"form-submit",onClick:g==="login"?Ao:Hr,disabled:se,style:{fontSize:".9rem",padding:"13px"},children:se?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"spinner",style:{width:16,height:16,borderWidth:2}}),"Chargement..."]}):g==="login"?"🔑 Se connecter":`🚀 Créer mon compte ${w==="buyer"?"Acheteur":w==="seller"?"Vendeur":w==="delivery"?"Livreur":"Prestataire"}`}),g==="register"&&e.jsx("p",{style:{fontSize:".68rem",color:"var(--gray)",textAlign:"center",marginTop:8},children:"En vous inscrivant, vous acceptez nos conditions d'utilisation"}),e.jsx("div",{className:"divider",children:"ou"}),e.jsxs("button",{className:"social-btn",onClick:No,children:[e.jsx("span",{children:"🇬"})," Continuer avec Google"]})]})}),e.jsxs("div",{className:`header-sticky-stack${eo?" header-sticky-stack--compact":""}`,children:[e.jsxs("div",{className:"topbar",children:[e.jsxs("div",{className:"topbar-l",children:[e.jsxs("div",{className:"flag-wrap",children:[e.jsxs("span",{className:"flag",children:[e.jsx("span",{className:"fg"}),e.jsx("span",{className:"fr"}),e.jsx("span",{className:"fy"})]}),e.jsx("span",{children:"Cameroun 🇨🇲"})]}),e.jsx("span",{children:"FR / EN"}),e.jsx("span",{children:"📞 +237 696 56 56 54"})]}),e.jsxs("div",{className:"topbar-r",children:[e.jsx("span",{onClick:()=>z("aide"),children:"🆘 Aide"}),e.jsx("span",{onClick:()=>z("contact"),children:"📞 Contact"}),n?e.jsxs("span",{style:{color:"#b7e4c7"},children:["👤 ",(d==null?void 0:d.nom)||((ot=n.email)==null?void 0:ot.split("@")[0])]}):e.jsx("span",{onClick:()=>{h("login"),v(!0)},children:"🔑 Se connecter"})]})]}),e.jsxs("nav",{className:"navbar",children:[e.jsx("div",{className:"logo-wrap",onClick:()=>z("home"),children:e.jsxs("div",{className:"logo-txt",children:["Yo",e.jsx("span",{children:"rix"}),e.jsx("sup",{children:"CM"})]})}),e.jsx("div",{className:"nav-search-wrap",children:e.jsxs("div",{className:"nav-search",children:[e.jsxs("select",{value:ie,onChange:s=>ae(s.target.value),"aria-label":"Filtrer par catégorie",children:[e.jsx("option",{value:"",children:"Tout"}),kt.map(s=>e.jsx("option",{children:s},s))]}),e.jsx("input",{placeholder:"Produit, marque, mot-clé…",value:L,onChange:s=>xe(s.target.value),onKeyDown:s=>s.key==="Enter"&&z("produits"),autoComplete:"off","aria-label":"Rechercher dans le catalogue","aria-expanded":L.trim().length>=2,"aria-haspopup":"listbox"}),L.trim().length>=2&&e.jsxs("div",{className:"nav-search-dd",role:"listbox","aria-label":"Suggestions catalogue",children:[W.filter(s=>(s.name_fr||"").toLowerCase().includes(L.toLowerCase())||(s.description_fr||"").toLowerCase().includes(L.toLowerCase())).slice(0,8).map(s=>{var f;return e.jsxs("button",{type:"button",className:"nav-search-dd-item",role:"option",onClick:()=>{xe(""),z("produits")},children:[s.image?e.jsx("img",{src:s.image,className:"nav-search-dd-img",alt:"",onError:u=>{u.currentTarget.style.visibility="hidden"}}):e.jsx("span",{className:"nav-search-dd-img nav-search-dd-ph","aria-hidden":!0,children:"📦"}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("div",{className:"nav-search-dd-t",children:s.name_fr}),e.jsxs("div",{className:"nav-search-dd-p",children:[(f=s.prix)==null?void 0:f.toLocaleString()," FCFA"]})]})]},s.id)}),W.filter(s=>(s.name_fr||"").toLowerCase().includes(L.toLowerCase())).length===0&&e.jsxs("div",{className:"nav-search-dd-empty",children:["Aucun résultat pour « ",L," » — touche Entrée pour ouvrir le catalogue filtré."]})]}),e.jsx("button",{type:"button",onClick:()=>z("produits"),"aria-label":"Lancer la recherche catalogue",children:"🔍"})]})}),e.jsxs("div",{className:"nav-actions",children:[e.jsx("button",{type:"button",className:"nav-cta-onboard",onClick:()=>Ae(!0),title:"Que cherchez-vous ?",children:"🚀 Démarrer"}),e.jsx("button",{className:"dark-toggle",onClick:()=>c(s=>!s),title:a?"Mode clair":"Mode sombre",children:a?"☀️":"🌙"}),n&&e.jsxs("button",{className:"icon-btn",onClick:()=>_e(s=>!s),title:"Notifications",children:["🔔",Ue>0&&e.jsx("span",{className:"ibadge",children:Ue})]}),e.jsxs("button",{className:"icon-btn",onClick:()=>z("cart"),title:"Mon panier",children:["🛒",gr>0&&e.jsx("span",{className:"ibadge",children:gr})]}),n?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:`role-chip ${tt()}`,children:jt[x||"buyer"]}),e.jsx("div",{className:"user-av",onClick:()=>z("dashboard"),title:"Mon espace",children:((d==null?void 0:d.nom)||n.email||"?")[0].toUpperCase()}),e.jsx("button",{className:"btn-red",onClick:Xr,title:"Déconnexion",children:"🚪 Déconnexion"})]}):e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"btn-ghost",onClick:()=>{h("login"),v(!0)},children:"🔑 Connexion"}),e.jsx("button",{className:"btn-green",onClick:()=>{h("register"),M("buyer"),v(!0)},children:"🚀 S'inscrire"})]})]})]}),e.jsxs("div",{className:"nav-tabs-row",ref:tr,children:[e.jsx("nav",{className:"nav-tabs","aria-label":"Rubriques Yorix",children:Fo.map(s=>e.jsx("div",{className:`tab${et(s.p)?" active":""}`,onClick:()=>{ne(!1),z(s.p)},role:"presentation",children:s.l},s.p))}),e.jsxs("div",{className:"nav-quick-wrap",children:[e.jsx("button",{type:"button",className:"nav-quick-btn","aria-expanded":Oe,onClick:()=>ne(s=>!s),children:"☰ Navigation"}),Oe&&e.jsx("div",{className:"nav-quick-panel",role:"dialog","aria-label":"Navigation Yorix",children:e.jsxs("div",{className:"nav-quick-mega-cols",children:[e.jsxs("div",{className:"nav-quick-section",children:[e.jsx("h4",{children:"Marketplace"}),e.jsx("div",{className:"nav-quick-links",children:[{ic:"🏠",l:"Accueil",p:"home"},{ic:"🛍️",l:"Produits & catalogue",p:"produits"},{ic:"🛒",l:"Panier · paiement sécurisé",p:"cart"},{ic:"🏷️",l:"Bons plans du moment",p:"bonsPlans"},{ic:"🚚",l:"Livraison & suivi",p:"livraison"}].map(s=>e.jsxs("button",{type:"button",onClick:()=>{ne(!1),z(s.p)},children:[e.jsx("span",{className:"nav-quick-ico",children:s.ic}),e.jsx("span",{children:s.l})]},s.l))})]}),e.jsxs("div",{className:"nav-quick-section",children:[e.jsx("h4",{children:"Confiance & croissance"}),e.jsx("div",{className:"nav-quick-links",children:[{ic:"🔐",l:"Escrow acheteur",p:"escrow"},{ic:"🧑‍🔧",l:"Prestataires vérifiés",p:"prestataires"},{ic:"💼",l:"Yorix Business",p:"business"},{ic:"🎓",l:"Academy",p:"academy"},{ic:"📰",l:"Blog & tendances CM",p:"blog"},{ic:"⭐",l:"Programme fidélité",p:"loyalty"}].map(s=>e.jsxs("button",{type:"button",onClick:()=>{ne(!1),z(s.p)},children:[e.jsx("span",{className:"nav-quick-ico",children:s.ic}),e.jsx("span",{children:s.l})]},s.l))})]}),e.jsxs("div",{className:"nav-quick-section",children:[e.jsx("h4",{children:"Support Yorix"}),e.jsxs("div",{className:"nav-quick-links",children:[e.jsxs("button",{type:"button",onClick:()=>{ne(!1),z("contact")},children:[e.jsx("span",{className:"nav-quick-ico",children:"📞"}),e.jsx("span",{children:"Contact relation client"})]}),e.jsxs("button",{type:"button",onClick:()=>{ne(!1),z("aide")},children:[e.jsx("span",{className:"nav-quick-ico",children:"🆘"}),e.jsx("span",{children:"SOS · centre d'aide"})]}),e.jsxs("button",{type:"button",onClick:()=>{ne(!1),z("faq")},children:[e.jsx("span",{className:"nav-quick-ico",children:"❓"}),e.jsx("span",{children:"FAQ marketplace"})]})]})]})]})})]})]}),e.jsxs("div",{className:"pay-strip",children:[e.jsx("b",{style:{color:"var(--ink)"},children:"Paiement :"}),e.jsxs("div",{className:"pay-methods",children:[e.jsx("span",{className:"pm mtn-b",children:"📱 MTN MoMo"}),e.jsx("span",{className:"pm ora-b",children:"🔶 Orange Money"}),e.jsx("span",{className:"pm",children:"💳 Carte"}),e.jsx("span",{className:"pm",children:"💵 Cash"})]}),e.jsxs("div",{className:"strip-right",children:[e.jsx("span",{children:"🚚 J+1 Douala & Yaoundé"}),e.jsxs("span",{role:"link",tabIndex:0,onClick:()=>z("bonsPlans"),onKeyDown:s=>s.key==="Enter"&&z("bonsPlans"),style:{cursor:"pointer",fontWeight:700,color:"var(--green)",textDecoration:"underline"},children:["Livraison offerte dès ",he.freeShippingThresholdXaf.toLocaleString("fr-FR")," FCFA"]}),e.jsx("span",{children:"🔐 Escrow sécurisé"}),n&&e.jsxs("span",{style:{color:"var(--gold)"},children:["👤 ",(d==null?void 0:d.nom)||n.email]})]})]})]}),Zt&&n&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"notif-backdrop",role:"presentation",onClick:()=>_e(!1)}),e.jsx("div",{className:"notif-drawer notif-drawer--premium",children:e.jsx(bn,{variant:"dropdown",user:n,notifs:Ee,goPage:z,onMarkRead:Gr,onMarkAllRead:Kr,onDismiss:Jr,onClose:()=>_e(!1),onPrefsUpdated:Le})})]}),i==="home"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{minHeight:280,label:"Chargement de l'accueil..."}),children:e.jsx(Ra,{filterCat:ie,setFilterCat:ae,search:L,setSearch:xe,produitsLoading:C,produits:W,user:n,userData:d,wishlist:De,addToCart:Fe,toggleWish:fr,openProductUrl:rt,setOnboardingOpen:Ae,goPage:z,allServices:F,nlEmail:Te,setNlEmail:ir,nlSent:ar,setNlSent:nr,freeShippingThresholdXaf:he.freeShippingThresholdXaf})}),Qr&&i==="livraison"&&t.citySlug&&$[t.citySlug]&&e.jsx(wt,{city:$[t.citySlug],mode:"livraison",goPage:z}),Qr&&i==="seoCity"&&t.citySlug&&$[t.citySlug]&&e.jsx(wt,{city:$[t.citySlug],mode:t.cityMode||"hub",goPage:z}),i==="productDetail"&&e.jsx("div",{className:"anim",children:bo?e.jsxs("div",{className:"loading",style:{minHeight:320,justifyContent:"center"},children:[e.jsx("div",{className:"spinner"})," Chargement du produit..."]}):Ne?e.jsx(l.Suspense,{fallback:e.jsx(B,{minHeight:320,label:"Chargement du produit..."}),children:e.jsx(La,{product:Ne,user:n,userData:d,onClose:()=>z("produits"),onAddToCart:Fe})}):e.jsx("section",{className:"sec anim",children:e.jsxs("div",{className:"empty-state",children:[e.jsx("div",{className:"empty-icon",children:"🔍"}),e.jsx("p",{children:"Produit introuvable."}),e.jsx("button",{className:"form-submit",style:{width:"auto",marginTop:16},type:"button",onClick:()=>z("produits"),children:"← Retour aux produits"})]})})}),Bo&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement catalogue..."}),children:e.jsx(Ma,{showProduits:Zr,page:i,seoCityName:de,produitsFiltres:Oo,produitsLoading:C,produits:W,filterCat:ie,setFilterCat:ae,search:L,user:n,userData:d,wishlist:De,addToCart:Fe,toggleWish:fr,openProductUrl:rt,dark:a,goPage:z})}),Do&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement livraison..."}),children:e.jsx(Pa,{route:t,user:n,userData:d,setDemandeLivraisonOpen:sr,setAuthTab:h,setSelectedRole:M,setAuthOpen:v})}),qo&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement prestataires..."}),children:e.jsx(Oa,{user:n,userData:d,allServices:F,goPage:z,setSelectedPrest:ye,selectedPrest:co,onOpenPrestDetail:s=>z("prestDetail",{prestSlug:mt(s.name,s.id)}),onClosePrestDetail:()=>{t.metierSlug&&t.villeSlug?z("prestataires",{metierSlug:t.metierSlug,villeSlug:t.villeSlug}):i==="seoCity"&&t.cityMode==="prestataires"&&t.citySlug?z("seoCity",{citySlug:t.citySlug,mode:"prestataires"}):z("prestataires")},syncFilters:To,onAddServiceToCart:Mo})}),i==="cart"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement panier..."}),children:e.jsx(qa,{cartItems:ue,cartSummary:pr,changeQty:Po,removeItem:Io,goPage:z,addToCart:Fe,produits:W,wishlist:De,toggleWish:fr})}),i==="checkout"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement checkout..."}),children:e.jsx(Da,{user:n,userData:d,cartItems:ue,summary:pr,setCartItems:Ce,goPage:z,fallbackWhatsappNumber:xa,momoNumber:fa,orangeNumber:ma,persistCheckoutContact:Lo})}),i==="notifications"&&!n&&e.jsxs("section",{className:"sec anim",style:{maxWidth:480,margin:"0 auto",textAlign:"center",padding:"48px 20px"},children:[e.jsx("h1",{className:"sec-title",style:{fontSize:"1.25rem"},children:"Vos notifications Yorix"}),e.jsx("p",{style:{color:"var(--gray)",marginBottom:22,fontSize:".9rem",lineHeight:1.55},children:"Connectez-vous pour suivre les messages, commandes, paiements et livraisons en temps réel."}),e.jsx("button",{type:"button",className:"form-submit",style:{width:"auto",padding:"12px 28px"},onClick:()=>{h("login"),v(!0)},children:"Se connecter"})]}),i==="notifications"&&n&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement notifications..."}),children:e.jsx(Xa,{user:n,notifs:Ee,goPage:z,onMarkRead:Gr,onMarkAllRead:Kr,onDismiss:Jr,refreshNotificationsFull:()=>qr(n.id,120),onPrefsUpdated:Le})}),Yo&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement page..."}),children:e.jsx(Ia,{page:i,goPage:z,setAuthOpen:v,setAuthTab:h,setSelectedRole:M,inscriptionSent:vo,setInscriptionSent:Wr,inscriptionForm:_,setInscriptionForm:jo,inscriptionError:ko,inscriptionLoading:wo,submitInscriptionPrestataire:So,academyCourses:qe,academyLoading:uo,goAcademyDetail:ho,blogFilter:so,setBlogFilter:lo,nlEmail:Te,setNlEmail:ir,nlSent:ar,setNlSent:nr,user:n,userData:d})}),i==="academyDetail"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement formation..."}),children:e.jsx(Ba,{course:Ur,goPage:z,goContact:yo})}),i==="academyContact"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement formulaire..."}),children:e.jsx(Ya,{course:Ur,user:n,userData:d,goPage:z})}),i==="bonsPlans"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement bons plans..."}),children:e.jsx(Ga,{goPage:z,freeShippingThresholdXaf:he.freeShippingThresholdXaf})}),i==="loyalty"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement fidélité..."}),children:e.jsx($a,{user:n,userData:d,goPage:z,setAuthOpen:v,setAuthTab:h})}),i==="dashboard"&&(n?e.jsxs("div",{className:"dash-layout anim",children:[e.jsxs("div",{className:"dash-sidebar",children:[e.jsx("div",{className:"dash-avatar",children:((it=d==null?void 0:d.nom)==null?void 0:it[0])||"U"}),e.jsx("div",{className:"dash-name",title:(d==null?void 0:d.nom)||n.email,children:(d==null?void 0:d.nom)||((at=n.email)==null?void 0:at.split("@")[0])||"Utilisateur"}),e.jsx("div",{className:"dash-role-badge",children:e.jsx("span",{className:`role-chip ${tt()}`,children:jt[x||"buyer"]})}),e.jsxs("div",{className:"dash-nav",children:[$o().map(s=>e.jsxs("div",{className:`dash-nav-item${X===s.id?" active":""}`,onClick:()=>le(s.id),children:[s.icon," ",s.label]},s.id)),e.jsx("div",{className:"dash-nav-divider"}),e.jsx("div",{className:`dash-nav-item${X==="messages"?" active":""}`,onClick:()=>le("messages"),children:"💬 Messages"}),e.jsx("div",{className:"dash-nav-item",onClick:Xr,style:{color:"var(--red)"},children:"🚪 Déconnexion"})]})]}),e.jsxs("div",{className:"dash-content",children:[X==="messages"&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"dash-page-title",children:"💬 Messagerie Yorix"}),e.jsx("div",{className:"info-msg",children:"🔐 Messagerie sécurisée entre acheteurs et vendeurs. Tes discussions sont privées et protégées."}),e.jsx(Ta,{user:n,userData:d})]}),X!=="messages"&&x==="seller"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement espace vendeur..."}),children:e.jsx(Fa,{user:n,userData:d,dashTab:X,setDashTab:le})}),X!=="messages"&&x==="delivery"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement espace livreur..."}),children:e.jsx(Wa,{user:n,userData:d,dashTab:X,setDashTab:le})}),X!=="messages"&&x==="provider"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement espace prestataire..."}),children:e.jsx(Va,{user:n,userData:d,dashTab:X,setDashTab:le})}),X!=="messages"&&(x==="buyer"||!x)&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement tableau de bord..."}),children:e.jsx(Ua,{user:n,userData:d,wishlist:De,totalQty:gr,loyaltyPts:ao,setLoyaltyPts:no,dashTab:X,goPage:z})})]})]}):e.jsxs("div",{className:"empty-state anim",style:{padding:"60px 0"},children:[e.jsx("div",{className:"empty-icon",children:"🔐"}),e.jsx("p",{children:"Connectez-vous pour accéder à votre espace"}),e.jsx("button",{className:"form-submit",style:{width:"auto",padding:"11px 28px",marginTop:16},onClick:()=>v(!0),children:"Se connecter"})]})),i!=="home"&&e.jsxs("div",{className:"newsletter",children:[e.jsx("div",{className:"nl-title",children:"📬 Restez informé(e)"}),e.jsx("p",{className:"nl-sub",children:"Les meilleures offres Yorix dans votre boîte mail."}),ar?e.jsx("div",{style:{background:"rgba(255,255,255,.2)",borderRadius:8,padding:"9px 18px",color:"#fff",fontWeight:600},children:"✅ Abonné(e) !"}):e.jsxs("div",{className:"nl-form",children:[e.jsx("input",{className:"nl-input",placeholder:"Votre email...",value:Te,onChange:s=>ir(s.target.value)}),e.jsx("button",{className:"nl-btn",onClick:async()=>{Te&&(await N.from("newsletter").insert({email:Te}).catch(s=>console.warn(s==null?void 0:s.message)),nr(!0))},children:"S'abonner 🚀"})]})]}),e.jsxs("div",{className:"yorix-fab-stack","aria-live":"polite",children:[n&&((d==null?void 0:d.role)==="admin"||(d==null?void 0:d.role)==="superadmin")&&i!=="admin"&&e.jsx("button",{type:"button",className:"admin-quick-pill",onClick:()=>z("admin"),title:"Ouvrir l’administration",children:"⚙️ Admin Yorix"}),e.jsxs("div",{className:"wa-float",children:[or&&e.jsxs("div",{className:"wa-card",children:[e.jsx("div",{className:"wa-card-title",children:"💬 Contacter Yorix"}),e.jsx("div",{className:"wa-card-sub",children:"Support 7j/7 · Réponse rapide"}),e.jsx("a",{href:`https://wa.me/${Ge}?text=${encodeURIComponent("Bonjour Yorix ! J'ai besoin d'aide.")}`,target:"_blank",rel:"noreferrer",className:"wa-link wa-link-green",children:"📱 WhatsApp +237 696 56 56 54"}),e.jsx("a",{href:"tel:+237696565654",className:"wa-link wa-link-ghost",children:"📞 Appeler"}),e.jsx("a",{href:"mailto:support@yorix.cm",className:"wa-link wa-link-ghost",children:"✉️ support@yorix.cm"})]}),e.jsxs("div",{style:{position:"relative",display:"flex",alignItems:"center",justifyContent:"center"},children:[e.jsx("div",{className:"wa-pulse"}),e.jsx("button",{type:"button",className:"wa-btn","aria-expanded":or,onClick:()=>oo(s=>!s),children:or?"✕":"💬"})]})]})]}),e.jsxs("div",{className:"mobile-nav",children:[e.jsx("div",{className:"mn-inner",children:[{icon:"🏠",label:"Accueil",p:"home"},{icon:"🛍️",label:"Produits",p:"produits"},{icon:"🚚",label:"Livraison",p:"livraison"},{icon:"📊",label:"Mon espace",p:"dashboard"},{icon:"💬",label:"WhatsApp",p:"wa"}].map(s=>e.jsxs("div",{className:`mn-item${et(s.p)?" active":""}`,onClick:()=>{s.p==="wa"?window.open(`https://wa.me/${Ge}?text=${encodeURIComponent("Bonjour Yorix ! J'ai besoin d'aide.")}`,"_blank"):s.p==="dashboard"&&!n?(h("register"),v(!0)):z(s.p)},children:[e.jsx("div",{className:"mn-icon",children:s.icon}),e.jsx("div",{className:"mn-label",children:s.label}),s.p==="dashboard"&&!n&&e.jsx("div",{style:{position:"absolute",top:0,right:2,background:"var(--green)",color:"#fff",fontSize:".45rem",fontWeight:700,padding:"1px 3px",borderRadius:3},children:"S'inscrire"}),s.p==="dashboard"&&Ue>0&&n&&e.jsx("div",{className:"mn-badge",children:Ue})]},s.label))}),!n&&e.jsxs("div",{style:{borderTop:"1px solid var(--border)",padding:"8px 16px",display:"flex",gap:8},children:[e.jsx("button",{onClick:()=>{h("login"),v(!0)},style:{flex:1,padding:"9px",borderRadius:8,border:"1.5px solid var(--border)",background:"var(--surface)",fontFamily:"'DM Sans',sans-serif",fontWeight:600,fontSize:".78rem",cursor:"pointer",color:"var(--ink)"},children:"🔑 Connexion"}),e.jsx("button",{onClick:()=>{h("register"),M("buyer"),v(!0)},style:{flex:2,padding:"9px",borderRadius:8,border:"none",background:"var(--green)",fontFamily:"'Syne',sans-serif",fontWeight:700,fontSize:".78rem",cursor:"pointer",color:"#fff"},children:"🚀 S'inscrire gratuitement"})]})]}),i==="admin"&&e.jsx(l.Suspense,{fallback:e.jsx(B,{label:"Chargement admin..."}),children:e.jsx(Ha,{user:n,userData:d,goPage:z})}),e.jsx(hn,{goPage:z,freeShippingThresholdXaf:he.freeShippingThresholdXaf})]})}jr.createRoot(document.getElementById("root")).render(e.jsx(oe.StrictMode,{children:e.jsx(Ci,{children:e.jsx(Wt,{children:e.jsx(jn,{})})})}));export{In as B,kt as C,Mn as D,Pn as E,fa as M,bn as N,ma as O,ha as P,Ln as R,Lt as S,Ge as Y,O as _,ba as a,$ as b,Ta as c,Rt as d,Qe as e,On as f,Dn as g,xa as h,qn as i,e as j,Sa as k,jt as l,Je as o,Bn as p,N as s,ui as u};
