...
Email : support@yorix.cm
WhatsApp : +237 696 56 56 54`}]}},p=o[r]||o.cgv;return e.jsx("section",{className:"sec anim",children:e.jsxs("div",{style:{maxWidth:820,margin:"0 auto"},children:[e.jsx("button",{onClick:()=>i("home"),style:{display:"flex",alignItems:"center",gap:6,background:"none",border:"none",cursor:"pointer",color:"var(--gray)",fontSize:14,marginBottom:20,padding:"8px 0"},children:"← Retour à l'accueil"}),e.jsx("h1",{style:{fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:"1.8rem",color:"var(--ink)",marginBottom:6,letterSpacing:"-.5px"},children:p.title}),e.jsx("p",{style:{fontSize:".78rem",color:"var(--gray)",marginBottom:28},children:p.updated}),e.jsx("div",{style:{background:"var(--surface)",border:"1px solid var(--border)",borderRadius:14,padding:"26px 30px"},children:p.content.map((g,b)=>e.jsxs("div",{style:{marginBottom:24},children:[e.jsx("h2",{style:{fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:"1rem",color:"var(--green)",marginBottom:8},children:g.h}),e.jsx("p",{style:{fontSize:".85rem",color:"var(--ink)",lineHeight:1.75,whiteSpace:"pre-line"},children:g.p})]},b))}),e.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"center",marginTop:24,flexWrap:"wrap"},children:[e.jsx("button",{onClick:()=>i("cgv"),style:{padding:"9px 18px",borderRadius:8,border:`1.5px solid ${r==="cgv"?"var(--green)":"var(--border)"}`,background:r==="cgv"?"var(--green)":"var(--surface)",color:r==="cgv"?"#fff":"var(--ink)",cursor:"pointer",fontFamily:"'DM Sans',sans-serif",fontWeight:600,fontSize:".8rem"},children:"📜 CGV"}),e.jsx("button",{onClick:()=>i("mentions"),style:{padding:"9px 18px",borderRadius:8,border:`1.5px solid ${r==="mentions"?"var(--green)":"var(--border)"}`,background:r==="mentions"?"var(--green)":"var(--surface)",color:r==="mentions"?"#fff":"var(--ink)",cursor:"pointer",fontFamily:"'DM Sans',sans-serif",fontWeight:600,fontSize:".8rem"},children:"📋 Mentions légales"}),e.jsx("button",{onClick:()=>i("confidentialite"),style:{padding:"9px 18px",borderRadius:8,border:`1.5px solid ${r==="confidentialite"?"var(--green)":"var(--border)"}`,background:r==="confidentialite"?"var(--green)":"var(--surface)",color:r==="confidentialite"?"#fff":"var(--ink)",cursor:"pointer",fontFamily:"'DM Sans',sans-serif",fontWeight:600,fontSize:".8rem"},children:"🔒 Confidentialité"})]}),e.jsxs("div",{style:{textAlign:"center",marginTop:20,fontSize:".78rem",color:"var(--gray)"},children:["Une question ? ",e.jsx("a",{href:"mailto:support@yorix.cm",style:{color:"var(--green)",fontWeight:600},children:"support@yorix.cm"})," · ",e.jsx("a",{href:"https://wa.me/237696565654",style:{color:"var(--green)",fontWeight:600},children:"WhatsApp"})]})]})})}function k({items:r}){return!Array.isArray(r)||r.length===0?null:e.jsx("nav",{className:"yorix-bc","aria-label":"Fil d'ariane",children:e.jsx("div",{className:"yorix-bc__list",children:r.map((i,o)=>{const p=o===r.length-1;return e.jsxs("span",{className:"yorix-bc__segment",children:[!p&&typeof i.onClick=="function"?e.jsx("button",{type:"button",className:"yorix-bc__link",onClick:i.onClick,children:i.label}):e.jsx("span",{className:p?"yorix-bc__current":"yorix-bc__link","aria-current":p?"page":void 0,children:i.label}),!p&&e.jsx("span",{className:"yorix-bc__sep","aria-hidden":"true",children:"›"})]},`${i.label}-${o}`)})})})}const C={BUSINESS:{icon:"📈",color:"#1565c0",pitch:"Stratégies, lancement, croissance"},LOCAL:{icon:"🌿",color:"#1a6b3a",pitch:"Produits locaux, terroir & export"},PAIEMENT:{icon:"💳",color:"#b45309",pitch:"Mobile money, fintech, escrow"},LIVRAISON:{icon:"🚚",color:"#ea580c",pitch:"Yorix Ride, logistique, suivi"},SÉCURITÉ:{icon:"🔐",color:"#7c3aed",pitch:"Escrow, anti-arnaque, confiance"},PRESTATAIRES:{icon:"⚡",color:"#dc2626",pitch:"Services à domicile, BTP, beauté"},MODE:{icon:"👗",color:"#db2777",pitch:"Style camerounais, wax, tendances"},CARRIÈRE:{icon:"🏍️",color:"#0891b2",pitch:"Devenir vendeur, livreur, freelance"}},Y=[{e:"🇨🇲",t:"100 % camerounais",d:"Rédigé par des journalistes basés à Douala et Yaoundé, sur le terrain."},{e:"✅",t:"Faits vérifiés",d:"Sources publiques, partenaires officiels, chiffres horodatés."},{e:"🧭",t:"Actionnable",d:"Chaque guide se termine par une étape concrète à exécuter aujourd'hui."},{e:"🛡️",t:"Indépendant",d:"Pas d'advertorial déguisé — la transparence éditoriale d'abord."}],B=["BUSINESS","SÉCURITÉ","LIVRAISON"];function S(r){r&&window.open(r,"_blank","noopener,noreferrer")}function T({p:r,size:i="normal"}){const o=C[r.cat]||{icon:r.emoji,color:"#1a6b3a"};return e.jsxs("article",{className:`yblog3-card yblog3-card--${i}`,role:"link",tabIndex:0,onClick:()=>S(r.external_url),onKeyDown:p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),S(r.external_url))},children:[e.jsxs("div",{className:"yblog3-card-media",style:{background:r.color_bg||"#e8f5e9"},children:[r.image?e.jsx("img",{src:r.image,alt:"",loading:"lazy",onError:p=>{p.currentTarget.style.display="none"}}):e.jsx("span",{className:"yblog3-card-emoji","aria-hidden":!0,children:r.emoji}),e.jsxs("span",{className:"yblog3-card-cat",style:{"--cat-color":o.color},children:[e.jsx("span",{"aria-hidden":!0,children:o.icon})," ",r.cat]}),e.jsxs("span",{className:"yblog3-card-read",children:[e.jsx("span",{"aria-hidden":!0,children:"⏱"})," ",r.read]})]}),e.jsxs("div",{className:"yblog3-card-body",children:[e.jsx("h3",{className:"yblog3-card-title",children:r.title}),e.jsx("p",{className:"yblog3-card-ex",children:r.excerpt}),r.tags&&r.tags.length>0&&e.jsx("div",{className:"yblog3-tags",children:r.tags.slice(0,3).map(p=>e.jsxs("span",{className:"yblog3-tag-sm",children:["#",p]},p))}),e.jsxs("div",{className:"yblog3-card-foot",children:[e.jsxs("div",{className:"yblog3-author",children:[e.jsx("div",{className:"yblog3-av","aria-hidden":!0,children:r.author_avatar||"Y"}),e.jsxs("div",{className:"yblog3-author-text",children:[e.jsx("div",{className:"yblog3-an",children:r.author}),e.jsx("div",{className:"yblog3-ad",children:r.date})]})]}),e.jsxs("span",{className:"yblog3-read-hint","aria-hidden":!0,children:["Lire ",e.jsx("span",{children:"→"})]})]})]})]})}function I({items:r}){return e.jsx("nav",{className:"yblog3-bc","aria-label":"Fil d'ariane",children:r.map((i,o)=>e.jsxs("span",{className:"yblog3-bc-item",children:[i.onClick?e.jsx("button",{type:"button",onClick:i.onClick,children:i.label}):e.jsx("span",{className:"yblog3-bc-current",children:i.label}),o<r.length-1&&e.jsx("span",{className:"yblog3-bc-sep","aria-hidden":!0,children:"›"})]},o))})}function W({blogFilter:r,setBlogFilter:i,nlEmail:o,setNlEmail:p,nlSent:g,setNlSent:b,goPage:t}){const[n,m]=x.useState(""),v=x.useMemo(()=>Array.from(new Set(y.map(a=>a.cat))),[]),d=x.useMemo(()=>{const a={TOUT:y.length};return y.forEach(h=>{a[h.cat]=(a[h.cat]||0)+1}),a},[]),u=x.useMemo(()=>{const a=n.trim().toLowerCase();return y.filter(h=>r==="TOUT"||h.cat===r).filter(h=>!a||h.title.toLowerCase().includes(a)||h.excerpt.toLowerCase().includes(a)||(h.tags||[]).some(A=>A.toLowerCase().includes(a)))},[r,n]),c=x.useMemo(()=>y.find(a=>a.featured&&(r==="TOUT"||a.cat===r))||u[0]||y[0],[r,u]),N=x.useMemo(()=>r==="TOUT"&&!n?u.filter(a=>a.id!==(c==null?void 0:c.id)):u,[u,c,r,n]),j=x.useMemo(()=>y.filter(a=>B.includes(a.cat)).slice(0,3),[]),z=async()=>{if(!(!o||!o.includes("@"))){try{await R.from("newsletter").insert({email:o})}catch(a){console.warn(a==null?void 0:a.message)}b(!0)}},f=c?C[c.cat]||{icon:c.emoji,color:"#1a6b3a"}:null;return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .yorix-blog-v3 {
      --jb-green: #1a6b3a;
