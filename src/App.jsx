...
import { PrestPage } from "./components/PrestPage";
    ...
    <>
          ...
          <section className="sec">
            ...
            {produitsLoading
              ...
              : produits.length===0
                ...
                : <ProdGrid prods={produits.slice(0,10)} user={user} userData={userData} onAddToCart={addToCart} onWish={toggleWish} wishlist={wishlist} onOpenProductUrl={openProductUrl}/>
            }
          </section>
      ...
      {showProduits&&(
        <section className="sec anim">
          ...
          {produitsLoading?<div className="loading"><div className="spinner"/>Chargement...</div>
            ...
            :<ProdGrid prods={produitsFiltres} user={user} userData={userData} onAddToCart={addToCart} onWish={toggleWish} wishlist={wishlist} onOpenProductUrl={openProductUrl}/>}
        </section>
      )}
      ...
      {page==="escrow"&&(
        <section className="sec anim">
          ...
          {produitsLoading?<div className="loading"><div className="spinner"/>Chargement...</div>
            :<ProdGrid prods={produits.filter(p=>p.escrow).slice(0,10)} user={user} userData={userData} onAddToCart={addToCart} onWish={toggleWish} wishlist={wishlist} onOpenProductUrl={openProductUrl}/>}
        </section>
      )}
      ...
      {/* ════════ PAGE : FAQ (extraite — snippets Google) ════════ */}
      {page==="faq"&&(
        <section className="sec anim">
      ...
      {/* ════════ DEVENIR VENDEUR / LIVREUR (SEO recrutement) ════════ */}
      {page==="devenirVendeur"&&(
        <section className="sec anim">
          <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
            ...
            <button type="button" className="cta-y" onClick={() => { setAuthTab("register"); setSelectedRole("seller"); setAuthOpen(true); }}>Créer ma boutique vendeur</button>
          </div>
        </section>
      )}
      {page==="devenirLivreur"&&(
        <section className="sec anim">
          <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
            ...
            <button type="button" className="cta-y" onClick={() => { setAuthTab("register"); setSelectedRole("delivery"); setAuthOpen(true); }}>S&apos;inscrire comme livreur</button>
          </div>
        </section>
      )}
