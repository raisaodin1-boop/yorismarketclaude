...
export const YORIX_WA_NUMBER = import.meta.env.VITE_YORIX_WA_NUMBER || "237696565654";
export const MOMO_NUMBER = import.meta.env.VITE_MOMO_NUMBER || "676935195";
export const ORANGE_NUMBER = import.meta.env.VITE_ORANGE_NUMBER || "696565654";
export const PAYMENT_WA_NUMBER =
  import.meta.env.VITE_PAYMENT_WA_NUMBER || import.meta.env.VITE_YORIX_WA_NUMBER || "237696565654";
