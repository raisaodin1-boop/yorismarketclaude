...
export async function submitDeliveryProQuote(form, userId = null) {
  ...
  // Public submitters intentionally have INSERT but not SELECT access to quote
  // rows. Requesting a RETURNING row makes PostgREST apply SELECT RLS after
  // inserting, which reports a failure and can prompt duplicate submissions.
